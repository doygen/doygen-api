...
class Worker {
     ...
     */
    makeWorkerContext(rule) {

        if (this.context.metadata.project.group) {
            this.context.metadata.project.groupPath = 
                this.context.metadata.project.group.replace('.', '/');
        }

        if (this.context.metadata.project.name) {
            this.context.metadata.project.nameLowerCase = 
                this.context.metadata.project.name.toLowerCase();
        }
